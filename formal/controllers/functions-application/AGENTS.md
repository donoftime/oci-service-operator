...
- Owned code: `pkg/servicemanager/functions/functionsapplication_servicemanager.go`
...
- Verified properties: success only on `ACTIVE`, retryable states requeue, finalizer stays until delete completes
