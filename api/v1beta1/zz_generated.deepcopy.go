...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerVnicSpec) DeepCopyInto(out *ContainerVnicSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerVnicSpec.
func (in *ContainerVnicSpec) DeepCopy() *ContainerVnicSpec {
	if in == nil {
		return nil
	}
	out := new(ContainerVnicSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ContainerInstanceSpec) DeepCopyInto(out *ContainerInstanceSpec) {
	*out = *in
	...
	if in.Vnics != nil {
		...
		*out = make([]ContainerVnicSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
