...
- [Services](services.md#services)
  ...
  - [OCI DevOps](devops.md#oci-devops)
    - [Overview](devops.md#overview)
    - [Prerequisites](devops.md#prerequisites)
    - [DevopsProject CRD](devops.md#devopsproject-crd)
    - [Example](devops.md#example)
